		...
		<div class="container">
			...
			<div class="collapse navbar-collapse"
				...
				<ul class="nav navbar-nav navbar-right">
					...
					<li class="page-scroll"><a href="#portfolio">능력자들</a></li>

					<li class="page-scroll">
					<li>
						<%-- <a href="/mypage/mypage?me_email=${sessionScope.MEMBER.me_email}">마이페이지</a> --%>
					...
					<li class="page-scroll">
						...
						<ul class="dropdown-menu"
							...
							<li><a href="/board/slist?bo_bbsid=04" style="width: 90px;">Q
									& A</a></li>
						</ul>
					</li>
					<li class="page-scroll"><a href="#about">우리는</a></li>
					<li class="page-scroll"><a href="#contact">연락처</a></li>
