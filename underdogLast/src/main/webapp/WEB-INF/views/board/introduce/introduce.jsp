 ...
 _________________________________________________________ -->
                    <div class="panel panel-default sidebar-menu">
                        ...
                        <div class="panel-heading">
                            <h3 class="panel-title">Pinterest?</h3>
                        </div>

                        <div class="panel-body">
                            <ul class="nav nav-pills nav-stacked">
                                <li>
                                    <a href="/board/introduce">회사소개</a>
                                </li>
                                <li>
                ...
                <div class="col-sm-9" id="blog-post">
                    ...
                    <div class="box">
                        ...
                        <div id="post-content">
                            ...
                            <p>
                                <img src="/resources/img/blog2.jpg" class="img-responsive" alt="Example blog post alt">
                            </p>
                            ...
                            <p>
                                <img src="/resources/img/blog.jpg" class="img-responsive" alt="Example blog post alt">
                            </p>
                        ...
                        <div id="comments" data-animate="fadeInUp">
                            ...
                            <div class="row comment">
                                <div class="col-sm-3 col-md-2 text-center-xs">
                                    <p>
                                        <img src="/resources/img/blog-avatar2.jpg" class="img-responsive img-circle" alt="">
                                    </p>
                                </div>
                            ...
                            <div class="row comment last">
                                ...
                                <div class="col-sm-3 col-md-2 text-center-xs">
                                    <p>
                                        <img src="/resources/img/blog-avatar.jpg" class="img-responsive img-circle" alt="">
                                    </p>
                                </div>
